...
\begin{figure}
  \centering
    \includegraphics[width=0.82\textwidth]{build/interface.PNG}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{build/interface_n_eff.PDF}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{build/interface_damage.PDF}
