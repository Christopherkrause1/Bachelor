...
\begin{figure}
    \includegraphics[width=0.95\textwidth]{build/interface.PNG}
...
\begin{figure}
  \includegraphics[width=0.9\textwidth]{build/interface_n_eff.PDF}
...
\begin{figure}
  \includegraphics[width=0.9\textwidth]{build/interface_damage.PDF}
