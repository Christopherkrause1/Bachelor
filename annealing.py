...
ax2 = ax1.twinx()
plt.semilogx(t_2/60, N_eff(t_2/60, 5*10**(15), T_5+273.15), 'b.', label='Änderung N_eff R1', Markersize=6)
plt.semilogx(t_2/60, N_eff(t_2/60, 5*10**(15), 80+273.15), 'k--', label='Änderung N_eff 80°C', Markersize=6)
...
#plt.title('Annealingeffekt ohne Korrektur')    #für WE-25k$\Omega$cm')
#plt.legend()
#plt.grid()
